...
The next bounded usability slice moves an enrolled group's **Progress at a glance**
table directly below its headline metrics. First-student onboarding remains visible
for an empty group, while repeat invitations and invitation history are collapsed
