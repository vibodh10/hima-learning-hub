...
| 8-10. Classes and curriculum selection | Flexible class creation, Groups 1-5 seed, different course per class, academic period, dates, additional teachers, controlled temporary registration links, CSV import, transfer/archive lifecycle, multi-unit and active-unit selection. Legacy class-code joining is disabled. |
