...
export function TopicWorksheet({
  ...
  return <section className="card" id="worksheet" aria-labelledby="worksheet-title">
    ...
    {catchUp&&<div className="mt-5 rounded-xl border border-amber-200 bg-amber-50 p-5 text-sm text-amber-950"><p className="font-bold">Missed this lesson?</p><ol className="mt-3 grid gap-2"><li>1. Watch the approved short lesson video when shown. If no video is currently approved, use the short lesson explanations above.</li><li>2. Complete the recap.</li><li>3. Complete this worksheet.</li><li>4. Complete the practical application.</li><li>5. Complete the knowledge check.</li><li>6. Record your reflection and exit ticket.</li></ol></div>}
