...
export function QuestionEditorForm({ activities, skills }: { activities: Option[]; skills: Option[] }) {
  ...
  return <form action={action} className="grid gap-4">
    ...
    <div className="grid gap-4 md:grid-cols-2"><Field label="Correct feedback"><textarea className="input min-h-20" name="feedbackCorrect" defaultValue="Correct — well reasoned." required/></Field><Field label="Incorrect feedback"><textarea className="input min-h-20" name="feedbackIncorrect" defaultValue="Review the explanation and try this skill again." required/></Field></div>
...
export function QuestionReviewForm({
  ...
  return <form action={action} className="mt-4 grid gap-3">
    ...
    <div className="grid gap-3 md:grid-cols-2"><Field label="Correct feedback"><textarea className="input min-h-16" name="feedbackCorrect" defaultValue={question.feedback_correct??"Correct — well reasoned."} required/></Field><Field label="Incorrect feedback"><textarea className="input min-h-16" name="feedbackIncorrect" defaultValue={question.feedback_incorrect??"Review the explanation and try again."} required/></Field></div>
