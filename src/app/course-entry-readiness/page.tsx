...
export default function CourseEntryReadinessPage(){
    ...
    return <main className="min-h-screen bg-slate-50">
        <nav className="shell flex items-center justify-between py-6" aria-label="Main navigation"><Link href="/" className="flex items-center gap-3 font-bold text-slate-950"><Mark>D</Mark><span>Digital Learning Hub</span></Link><Link href="/login" className="button button-small">Sign in</Link></nav>
