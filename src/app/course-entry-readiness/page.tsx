...
export default function CourseEntryReadinessPage(){
    ...
    const criteria=useMemo(()=>student.pathway==="btec-national-diploma-it"?["4 GCSEs at Grade 3 or above","Grade 4+ in either English or Maths","OR Functional Skills Level 2 / Level 2 BTEC / related Level 2 Digital Diploma","Age 16+ · Digbeth or Longbridge"]:student.pathway==="btec-extended-diploma-it"?["4 GCSEs at Grade 4 or above","English Grade 4+","Maths Grade 4+","Age 16+ · Longbridge"]:["4 GCSEs at Grade 4 or above","English Grade 4+","Maths Grade 4+","Age 16 to 18 · Digbeth"],[student.pathway]);
    ...
    return <main className="min-h-screen bg-slate-50">
        <nav className="shell flex items-center justify-between py-6" aria-label="Main navigation"><Link href="/" className="flex items-center gap-3 font-bold text-slate-950"><Mark>S</Mark><span>SCCB <span className="text-teal-700">Digital Learning Hub</span></span></Link><Link href="/login" className="button button-small">Sign in</Link></nav>
