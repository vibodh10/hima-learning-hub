...
export default async function RewardsPage() {
  ...
  return <><AppHeader name={actor.display_name} role={actor.role}/><main className="shell py-10">
    ...
    <details className="card mt-8"><summary className="cursor-pointer text-lg font-bold">Choose a cosmetic reward</summary><p className="mt-2 text-sm text-slate-600">Optional. Rewards never affect marks or required work.</p><section className="mt-6 grid gap-5 md:grid-cols-3">{rewards?.map(reward => <article className="card" key={reward.id}>
