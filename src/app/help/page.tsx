...
const administratorSteps = [
  ...
  ["2", "Give tutors access", "Open Administration and create each tutor's secure password-setup link. Send it by staff email, or copy it privately to their verified staff Teams account."],
