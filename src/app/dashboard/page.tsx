...
export default async function DashboardPage({searchParams}:{searchParams:Promise<TeacherFilters>}) {
  ...
  return <><AppHeader name={profile.role === "teacher" ? "Hima" : profile.display_name} role={profile.role}/>
