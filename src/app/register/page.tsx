...
export default function RegisterPage() {
  return <main className="shell grid min-h-screen place-items-center py-12"><div className="w-full max-w-lg">
    ...
    <section className="card text-center">
      ...
      <p className="mt-4 leading-7 text-slate-600">SCCB Digital Learning Hub sends each student a secure invitation to their verified email address. Their student profile and correct class access are confirmed only after secure acceptance; students cannot register themselves as a teacher or administrator.</p>
