...
export default async function TopicPage({ params }: { params: Promise<{ unitCode: string; topicCode: string }> }) {
  ...
  return <main className="shell py-10">
    ...
    <div className="mt-8"><AtomTopicHub unit={unit} topic={topic} storageKey={progressKeyFor(actor?.id ?? "guest")}/></div>
  </main>;
}
