...
export default async function StudyPage() {
  ...
  const showAssignment=await hasAssignedCurriculumUnit("6");
  let home:StudyHome;
  ...
  return <div className="mini-study-surface">
    ...
    <footer className="mini-study-footer"><Link href="/rewards">My rewards · points, badges and themes</Link>{showAssignment&&<Link href="/study/assignment-one">Assignment 1 preparation · 28 September</Link>}<Link href="/help">Need help?</Link></footer>
  </div>;
}
