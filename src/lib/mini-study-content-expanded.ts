 ...
 * while Unit 6 gains the design, build, scripting, publishing and stretch steps.
 */
export function studyContentFor(unitCode:string) {
  const base=baseStudyContentFor(unitCode);
  if(!base)return undefined;
  if(unitCode!=="6")return base;
  return {...base,version:"u6-complete-v1",lessons:[...base.lessons,...unit6ExtensionStudy.lessons]};
}
