...
import {unit19SowPracticeStudy} from "./mini-study-unit19-sow-practice";

/**
 * The wider lesson banks remain available for future teaching progress, while
...
export function studyContentFor(unitCode:string) {
  ...
  if(unitCode==="19")return {...base,version:"u19-complete-v2",lessons:[...base.lessons,...unit19SowPracticeStudy.lessons]};
