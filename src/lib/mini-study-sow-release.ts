...
const unit4Releases:SowRelease[]=[
  ...
  {lessonId:"u4-functions-parameters-v1",releaseOn:"2026-10-02",title:"Functions with parameters and return values"},
  {lessonId:"u4-while-practice-v1",releaseOn:"2026-09-23",title:"While loop: keep going until the condition changes"},
  {lessonId:"u4-return-values-practice-v1",releaseOn:"2026-10-02",title:"Return: send a result back from a function"},
  {lessonId:"u4-function-while-v1",releaseOn:"2026-10-02",title:"Combine a function with a while loop"},
  {lessonId:"u4-function-while-if-v1",releaseOn:"2026-10-02",title:"Combine a function, while loop and if decision"},
  {lessonId:"u4-choice-menu-if-v1",releaseOn:"2026-10-02",title:"Build a simple menu using choice and if"},
  {lessonId:"u4-function-menu-choice-if-v1",releaseOn:"2026-10-02",title:"Put the menu inside a function"},
  {lessonId:"u4-lists-practical-v1",releaseOn:"2026-10-02",title:"Use a list, display values and change a value"},
  {lessonId:"u4-pandas-practical-v1",releaseOn:"2026-09-25",title:"Pandas: display and change table values"},
  {lessonId:"u4-pygame-runner-loop-v1",releaseOn:"2026-10-09",title:"Pygame runner: understand the main game loop"},
  {lessonId:"u4-pygame-moving-world-v1",releaseOn:"2026-10-09",title:"Move the character and scrolling background"},
  {lessonId:"u4-pygame-obstacles-v1",releaseOn:"2026-10-09",title:"Add colourful obstacles using functions, loops and if"},
  {lessonId:"u4-scope-v1",releaseOn:"2026-10-02",title:"Local and global scope"},
